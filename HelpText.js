...
+ "<li>Click <strong>Display Interval</strong> button to show interval names of notes.</li>"
+ "<li>Click <strong>Display Notes</strong> button to return to showing names of notes.</li>"
+ "<li>Use the <strong>'Key of:' pull-down</strong> to change the note names when the notes are displayed.</li>"
